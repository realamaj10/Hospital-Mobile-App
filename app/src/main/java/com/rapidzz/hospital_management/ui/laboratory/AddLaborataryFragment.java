...
import com.rapidzz.hospital_management.databinding.FragmentAddLaboratoryBinding;
import com.rapidzz.hospital_management.models.StaffModel;

import java.util.HashMap;

public class AddLaborataryFragment extends BaseFragment<FragmentAddLaboratoryBinding> {
    DatabaseReference reference;
    String gender = "Male";
    StaffModel model;
    FragmentAddLaboratoryBinding binding;

    @Override
    public void initView(FragmentAddLaboratoryBinding binding) {
        ...
        binding.btnRemoveDoctor.setOnClickListener(view -> {
    ...
    private void updateUI() {
        ...
        binding.btnAddDoctor.setText("Update Laboratory");
        binding.etCNIC.setEnabled(false);
        binding.btnRemoveDoctor.setVisibility(View.VISIBLE);
    }
    ...
    public int getLayoutId() {
        return R.layout.fragment_add_laboratory;
    }
