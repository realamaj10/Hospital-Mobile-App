...
import com.rapidzz.hospital_management.databinding.FragmentAddDoctorBinding;
...
public class AddDoctorFragment extends BaseFragment<FragmentAddDoctorBinding> {
    ...
    @Override
    public void initView(FragmentAddDoctorBinding binding) {
...
//                }
    ...
    private void getArgument() {
        if (getArguments().containsKey("model") && getArguments().getSerializable("model") != null) {
            model = (DoctorsModel) getArguments().getSerializable("model");
